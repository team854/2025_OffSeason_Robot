...
public class TagUtilities {
     ...
     */
    public static Pose3d getReefTagPose(int tagID, boolean facingTag) {
        ...
        if (facingTag) {
            tagPose = tagPose.rotateBy(new Rotation3d(0, 0, Units.degreesToRadians(180)));
        }
        return tagPose;
    }
     ...
     * @return The pose of the tag
     */
    public static Pose3d getReefTagPose(int tagID) {
        Pose3d tagPose = Constants.APRIL_TAG_FIELD_LAYOUT.getTagPose(tagID).get();
        return tagPose;
    }
}
